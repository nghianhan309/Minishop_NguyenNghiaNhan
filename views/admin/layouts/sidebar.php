    ...
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white">
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu">
            <li class="nav-item w-100 mb-1">
                <a href="/MiniShop_NguyenNghiaNhan/admin/dashboard" class="nav-link align-middle px-0 text-white">
            ...
            <li class="nav-item w-100 mb-1">
                <a href="/MiniShop_NguyenNghiaNhan/admin/brand" class="nav-link align-middle px-0 text-white">
            ...
            <li class="nav-item w-100 mb-1">
                <a href="/MiniShop_NguyenNghiaNhan/admin/customer" class="nav-link align-middle px-0 text-white">
            ...
            <?php endif; ?>
            <li class="nav-item w-100 mb-1">
                <a href="/MiniShop_NguyenNghiaNhan/admin/order" class="nav-link align-middle px-0 text-white">
